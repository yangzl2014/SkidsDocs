...
SkidsSource(Gateway):
  ...
  + SK_Gateway.py：主程序，设置PANID，连接WiFi，接收传感数据并发布、显示，订阅主题接收MQTT消息并下发
...
首先修改TB_Sensor_EndDevice.py、TB_Control_EndDevice.py、SK_Gateway.py、SK_EndDevice.py中的PANID，
要唯一，以建立自己的ZigBee网，防止与其他人冲突。
